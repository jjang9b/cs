<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("select[name='database']").change( function( e ){ 
      ...
      ajax('GET', '/wiz/restrict/getTableList', $.param(oData), showTableList4Account, onError);
    });
    ...
    $("select[name='main_table']").change( function(){ 
      ...
      $.get( '/wiz/restrict/getColumnList', { database : database, table : table }, function( r ){
    ...
    <div class="col-xs-12">
      <div class="box box-gray">
        <div class="box-header">
          ...
          <small><b class="text-red">유저 제재 및 해제 / 조회</b> 페이지 생성</small></h3>
        </div>
        <form id="fo" name="fo" action="/wiz/restrict/create" method="post">
          <div class="box-body">
...
?>
        ...
        <input type="hidden" name="htype" value="restrict" />
      </form>
  </div>
</div>
