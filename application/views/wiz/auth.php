    ...
    <div class="col-xs-12">
      <div class="box box-navy">
        <div class="box-header">
          ...
          <small><b class="text-red">GM 페이지 관리</b> 페이지 생성</small></h3>
        </div>

        <form id="fo" name="fo" action="/wiz/auth/create" method="post">
          <div class="box-body">
...
?>
        ...
        <input type="hidden" name="htype" value="auth" />
      </form>
  </div>
</div>
