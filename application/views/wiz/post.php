<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("select[name='database']").change( function( e ){ 
      ...
      ajax('GET', '/wiz/post/getTableList', $.param(oData), showTableList4Account, onError);
    });
    ...
    $("select[name='main_table']").change( function(){ 
      ...
      $.get( '/wiz/post/getColumnList', { database : database, table : table }, function( r ){
    ...
    <div class="col-xs-12">
      <div class="box box-gray">
        <div class="box-header">
          ...
          <small><b class="text-red">우편함 지급</b> 페이지 생성</small></h3>
        </div>

        <form id="fo" name="fo" action="/wiz/post/create" method="post">
          <div class="box-body">
...
?>
        ...
        <input type="hidden" name="htype" value="post" />
      </form>
  </div>
</div>
