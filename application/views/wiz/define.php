<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("select[name='database']").change( function( e ){ 
      ...
      ajax('GET', '/wiz/define/getTableList', $.param(oData), showTableList4Account, onError);
    });
    ...
    $("select[name='tab_table_all[]']").click( function(){ 
      ...
      for( i = 0, j = aDisplayTabId.length; i < aSelectedTable.length; i++)
      {
        ...
        $.get( '/wiz/define/getColumnList', { database : database , table : _tmp_cur_table_name }, function( r ){
    ...
    <div class="col-xs-12">
      <div class="box box-gray">
        <div class="box-header">
          ...
          <small><b class="text-red">Define</b> 조회 페이지 생성</small></h3>
        </div>

        <form id="fo" name="fo" action="/wiz/define/create" method="post">
          <div class="box-body">
...
?>
        ...
        <input type="hidden" name="htype" value="define" />
      </form>
  </div>
</div>
